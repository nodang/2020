...
;* Date/Time created: Fri Mar 20 20:33:36 2020                 *
;***************************************************************
...
DW$35	.dwtag  DW_TAG_loop
	.dwattr DW$35, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L1:1:1584704016")
...
DW$42	.dwtag  DW_TAG_loop
	.dwattr DW$42, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L2:1:1584704016")
...
DW$47	.dwtag  DW_TAG_loop
	.dwattr DW$47, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L3:2:1584704016")
...
DW$49	.dwtag  DW_TAG_loop
	.dwattr DW$49, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L5:2:1584704016")
...
DW$59	.dwtag  DW_TAG_loop
	.dwattr DW$59, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L7:1:1584704016")
...
DW$66	.dwtag  DW_TAG_loop
	.dwattr DW$66, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L8:1:1584704016")
...
DW$71	.dwtag  DW_TAG_loop
	.dwattr DW$71, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L9:2:1584704016")
...
DW$73	.dwtag  DW_TAG_loop
	.dwattr DW$73, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L11:2:1584704016")
...
DW$81	.dwtag  DW_TAG_loop
	.dwattr DW$81, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L13:1:1584704016")
...
DW$84	.dwtag  DW_TAG_loop
	.dwattr DW$84, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L14:1:1584704016")
...
DW$89	.dwtag  DW_TAG_loop
	.dwattr DW$89, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L15:1:1584704016")
...
;*** 186	-----------------------    EPwm1Regs.CMPA.half.CMPA = 9989u;
;*** 187	-----------------------    EPwm1Regs.CMPB = 9989u;
;*** 188	-----------------------    EPwm2Regs.CMPB = 9989u;
;*** 189	-----------------------    EPwm2Regs.CMPA.half.CMPA = 9989u;
;*** 191	-----------------------    *&GpioDataRegs &= 0xfffeu;
;*** 192	-----------------------    *&GpioDataRegs &= 0xfffeu;
;*** 193	-----------------------    *&GpioDataRegs &= 0xfffeu;
;*** 194	-----------------------    *&GpioDataRegs &= 0xfffeu;
	.dwpsn	"DSP280x_Sci.c",185,3
        MOVW      DP,#_CpuTimer2Regs+4
        OR        @_CpuTimer2Regs+4,#0x0010 ; |185| 
	.dwpsn	"DSP280x_Sci.c",186,3
        MOVW      DP,#_EPwm1Regs+9
        MOV       @_EPwm1Regs+9,#9989   ; |186| 
	.dwpsn	"DSP280x_Sci.c",187,3
        MOV       @_EPwm1Regs+10,#9989  ; |187| 
	.dwpsn	"DSP280x_Sci.c",188,3
        MOVW      DP,#_EPwm2Regs+10
        MOV       @_EPwm2Regs+10,#9989  ; |188| 
	.dwpsn	"DSP280x_Sci.c",189,3
        MOV       @_EPwm2Regs+9,#9989   ; |189| 
	.dwpsn	"DSP280x_Sci.c",191,3
        MOVW      DP,#_GpioDataRegs
        AND       @_GpioDataRegs,#0xfffe ; |191| 
	.dwpsn	"DSP280x_Sci.c",192,3
        AND       @_GpioDataRegs,#0xfffe ; |192| 
	.dwpsn	"DSP280x_Sci.c",193,3
        AND       @_GpioDataRegs,#0xfffe ; |193| 
	.dwpsn	"DSP280x_Sci.c",194,3
        AND       @_GpioDataRegs,#0xfffe ; |194| 
L20:    
;***	-----------------------g7:
...
DW$93	.dwtag  DW_TAG_loop
	.dwattr DW$93, DW_AT_name("C:\Users\노호진\Desktop\2809_DRONE\2809_LF_DRONE_V1\main\DSP280x_Sci.asm:L18:1:1584704016")
