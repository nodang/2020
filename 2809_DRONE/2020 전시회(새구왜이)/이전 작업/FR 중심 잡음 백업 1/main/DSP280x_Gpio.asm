...
_InitGpio:
;*** 26	-----------------------    asm(" EALLOW");
;*** 65	-----------------------    GpioCtrlRegs.GPAMUX1.all = 0xa0000055uL;
;*** 105	-----------------------    GpioCtrlRegs.GPAMUX2.all = 0x50a0510uL;
;*** 116	-----------------------    GpioCtrlRegs.GPBMUX1.all = 0uL;
;*** 159	-----------------------    GpioCtrlRegs.GPADIR.all = 0x2ccd7fffuL;
