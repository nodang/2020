...
{	
	...
	Kp_iq17_FR = _IQmpy(_IQ(Kp), _IQ17(Error_f32_FrontRight));
	Kp_iq17_RR = _IQmpy(_IQ(Kp), _IQ17(Error_f32_RearRight));
	Kp_iq17_RL = _IQmpy(_IQ(Kp), _IQ17(Error_f32_RearLeft));
	
	//I제어		인터럽트 주기 5ms(cputimer 5000)		PWM 주기 5ms(tbprd 50000)
	Ki_iq17_FL += _IQmpy(_IQmpy(_IQ17(Ki),  _IQ17(Error_f32_FrontLeft)), _IQ(5));
	Ki_iq17_FR += _IQmpy(_IQmpy(_IQ17(Ki),  _IQ17(Error_f32_FrontRight)), _IQ(5));
	Ki_iq17_RR += _IQmpy(_IQmpy(_IQ17(Ki),  _IQ17(Error_f32_RearRight)), _IQ(5));
	Ki_iq17_RL += _IQmpy(_IQmpy(_IQ17(Ki),  _IQ17(Error_f32_RearLeft)), _IQ(5));

	//D제어 
	Kd_iq17_FL = _IQdiv(_IQmpy(_IQ(Kd), _IQ17(Err_f32_FL[0])), _IQ17(5));
	Kd_iq17_FR = _IQdiv(_IQmpy(_IQ(Kd), _IQ17(Err_f32_FR[0])), _IQ17(5));
	Kd_iq17_RR = _IQdiv(_IQmpy(_IQ(Kd), _IQ17(Err_f32_RR[0])), _IQ17(5));
	Kd_iq17_RL = _IQdiv(_IQmpy(_IQ(Kd), _IQ17(Err_f32_RL[0])), _IQ17(5));

	//최종 모터 제어
	//보정 값 right 10
	Front_Left_Motor	= (Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_FL + Ki_iq17_FL + Kd_iq17_FL)) >= Motor_Limit ? Motor_Limit : Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_FL + Ki_iq17_FL + Kd_iq17_FL);
	Front_Right_Motor 	= (Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_FR + Ki_iq17_FR + Kd_iq17_FR)) >= Motor_Limit ? Motor_Limit : Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_FR + Ki_iq17_FR + Kd_iq17_FR);
	//Rear_Left_Motor	= Motor_Stop_position + Motor_Speed + IQtoI(Kp_iq17_FR + Ki_iq17_FR + Kd_iq17_FR);
	Rear_Left_Motor		= (Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_RL + Ki_iq17_RL + Kd_iq17_RL)) >= Motor_Limit ? Motor_Limit : Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_RL + Ki_iq17_RL + Kd_iq17_RL);
	//Rear_Right_Motor	= Motor_Stop_position + Motor_Speed + IQtoI(Kp_iq17_FL + Ki_iq17_FL + Kd_iq17_FL);
	Rear_Right_Motor	= (Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_RR + Ki_iq17_RR + Kd_iq17_RR)) >= Motor_Limit ? Motor_Limit : Motor_Stop_position + Motor_Speed - IQtoI(Kp_iq17_RR + Ki_iq17_RR + Kd_iq17_RR);
#endif	
