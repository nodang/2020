...
{	
	...
	{
		Kp_U16_FL = (Uint16)(Kp_out * (_IQabs(_IQ17(abs(Error_f32_FrontLeft))) >> 17));		
		Kp_U16_RR = Kp_U16_FL / 3;
		
		Kp_U16_FR = (Uint16)(Kp_out * (_IQabs(_IQ17(abs(Error_f32_FrontRight))) >> 17)); 			
		Kp_U16_RL = Kp_U16_FR / 3;
	}
	else if((Error_f32_FrontLeft > 0) && (Error_f32_FrontRight > 0) && (Error_f32_RearLeft <= 0) && (Error_f32_RearRight <= 0))	//뒤로 기울어짐
	{
		Kp_U16_RR = (Uint16)(Kp_out * (_IQabs(_IQ17(abs(Error_f32_FrontLeft))) >> 17));		
		Kp_U16_FL = Kp_U16_RR / 3;
		
		Kp_U16_RL = (Uint16)(Kp_out * (_IQabs(_IQ17(abs(Error_f32_FrontRight))) >> 17)); 			
		Kp_U16_FR = Kp_U16_RL / 3;
	}
