...
DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("SCIB_ISR"), DW_AT_symbol_name("_SCIB_ISR")
...
;*** 129	-----------------------    PieVectTable.SCIRXINTA = &SCIA_ISR;
;*** 130	-----------------------    PieVectTable.SCIRXINTB = &SCIB_ISR;
;*** 132	-----------------------    asm(" EDIS");
;*** 135	-----------------------    IER |= 0x100u;
;*** 136	-----------------------    IER |= 0x2000u;
;*** 140	-----------------------    *(&PieCtrlRegs+18L) |= 1u;
;*** 141	-----------------------    *(&PieCtrlRegs+18L) |= 4u;
;*** 143	-----------------------    ConfigCpuTimer(&CpuTimer0, 100.0F, 25000.0F);
;*** 144	-----------------------    ConfigCpuTimer(&CpuTimer2, 100.0F, 10000.0F);
;*** 146	-----------------------    asm(" clrc INTM");
;*** 147	-----------------------    asm(" clrc DBGM");
;*** 147	-----------------------    return;
	.dwcfa	0x1d, -2
 ...
 EALLOW
	...
	.dwpsn	"DSP280x_CpuTimers.c",129,2
        ...
        MOVL      XAR4,#_SCIA_ISR       ; |129| 
        MOVL      @_PieVectTable+192,XAR4 ; |129| 
	.dwpsn	"DSP280x_CpuTimers.c",130,2
        MOVL      XAR4,#_SCIB_ISR       ; |130| 
        MOVL      @_PieVectTable+196,XAR4 ; |130| 
 ...
 EDIS
	...
	.dwpsn	"DSP280x_CpuTimers.c",140,2
        ...
        OR        @_PieCtrlRegs+18,#0x0001 ; |140| 
	.dwpsn	"DSP280x_CpuTimers.c",141,2
        OR        @_PieCtrlRegs+18,#0x0004 ; |141| 
	...
	.dwpsn	"DSP280x_CpuTimers.c",144,2
        ...
        MOVL      *-SP[2],ACC           ; |144| 
        MOV       AL,#0
        MOVL      XAR4,#_CpuTimer2      ; |144| 
        MOV       AH,#17096
        LCR       #_ConfigCpuTimer      ; |144| 
        ; call occurs [#_ConfigCpuTimer] ; |144| 
	.dwpsn	"DSP280x_CpuTimers.c",146,2
 clrc INTM
	.dwpsn	"DSP280x_CpuTimers.c",147,2
 clrc DBGM
	.dwpsn	"DSP280x_CpuTimers.c",149,1
        SUBB      SP,#2
	.dwcfa	0x1d, -2
        SPM       #0
        LRETR
	...
	.dwattr DW$19, DW_AT_end_line(0x95)
