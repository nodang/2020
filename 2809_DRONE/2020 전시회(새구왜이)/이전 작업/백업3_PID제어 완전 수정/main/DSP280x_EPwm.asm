...
;* Date/Time created: Sat Mar 07 22:05:24 2020                 *
;***************************************************************
...
;*** 32	-----------------------    *(volatile unsigned *)pPWM = *(volatile unsigned *)pPWM&0xefffu|0xc00u;
;*** 33	-----------------------    *(volatile unsigned *)pPWM = *(volatile unsigned *)pPWM&0xfeffu|0x280u;
...
DW$3	.dwtag  DW_TAG_variable, DW_AT_name("pPWM"), DW_AT_symbol_name("_pPWM")
	...
	.dwpsn	"DSP280x_EPwm.c",32,2
        AND       AL,*+XAR4[0],#0xefff  ; |32| 
        OR        AL,#0x0c00            ; |32| 
        MOV       *+XAR4[0],AL          ; |32| 
	.dwpsn	"DSP280x_EPwm.c",33,2
        AND       AL,*+XAR4[0],#0xfeff  ; |33| 
        OR        AL,#0x0280            ; |33| 
        MOV       *+XAR4[0],AL          ; |33| 
