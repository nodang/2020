...
{	
	...
	while( 1 )
	{
		...
		TxPrintf("dt : %lu | fl : %lf | fr : %lf | t1 : %u | t2 : %u | t3 : %u | t4 : %u | ",UltraSonic_U32_distance ,Error_f32_FrontLeft, Error_f32_FrontRight, test_pwm1, test_pwm2, test_pwm3, test_pwm4);
